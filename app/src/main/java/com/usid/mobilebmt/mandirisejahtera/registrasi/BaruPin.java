...
public class BaruPin extends AppCompatActivity implements IAsyncHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pin_baru);
        ...
        if (5 != telpMan.telephonyManager().getSimState()) {
            ...
            imsi = Utility.getIMSIRegister(this);
        }

        NumSky nmsk = new NumSky(BaruPin.this);
        try {
        ...
        btnOK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (jwtlocal.equals("0")) {
                    Toast.makeText(BaruPin.this, "Tidak bisa diproses, periksa koneksi anda tunggu hingga indikator berwarna biru", Toast.LENGTH_SHORT).show();
                } else {
                    if (!validatePassLama()) {
                        return;
                    }
    ...
    private class AsyncGantiPIN extends AsyncTask<Void, Void, Void> {
        ProgressDialog pdLoading = new ProgressDialog(BaruPin.this);
        ...
        protected Void doInBackground(Void... params) {
            try {
                URL obj = new URL(MyVal.URL_BASE() + new NumSky(BaruPin.this).decrypt(getResources().getString(R.string.urlVerifikasiPIN)));
                Log.d("AYIK", "barupin:obj " + obj.toString());
                ...
                String strCek = toJsonString(nokartu, imsi, Utility.md5(strPIN),
                        Utility.md5(strPINBaru));

                Log.d("AYIK", "barupin:response " + strCek);
                ...
                Log.d("AYIK", "barupin:response " + response.toString());
        ...
        protected void onPostExecute(Void result) {
            ...
            if (stGantiPin) {
               /* SysDB dbsys = new SysDB(BaruPin.this);
                dbsys.open();
               ...
               /* if (!ket.equals("404 Error koneksi terputus!!\nSilahkan coba lagi")) {
                ...
                showAlert("Verifikasi PIN GAGAL", msga);
            }
        }
    }
    ...
    private void showConfirm(String title, String message) {
        new AlertDialog.Builder(this).setTitle(title).setMessage(message).setCancelable(false).setNegativeButton("OK", new DialogInterface.OnClickListener() {
            @Override
    ...
    protected void onResume() {
        ...
        if (stats && sts > 1) {
            ...
            AuthLogin2 task = new AuthLogin2(BaruPin.this, BaruPin.this);
            task.execute();
        }
    }
