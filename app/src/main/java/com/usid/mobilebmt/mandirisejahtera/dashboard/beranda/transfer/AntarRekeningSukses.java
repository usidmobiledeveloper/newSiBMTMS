...
import com.usid.mobilebmt.mandirisejahtera.databinding.ActivityAntarRekeningSuksesBinding;
...
public class AntarRekeningSukses extends AppCompatActivity {

    ActivityAntarRekeningSuksesBinding binding;
    String judul;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityAntarRekeningSuksesBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        Utility.playNotificationSound(AntarRekeningSukses.this);
    ...
    private void takeScreenshot() {
        try {
           ...
           /* } else {
            ...
            Toast.makeText(AntarRekeningSukses.this, "Gagal menyimpan screenshoot", Toast.LENGTH_SHORT).show();
            e.printStackTrace();
        }
    }
...
//        Uri uri = Uri.parse("file://" + imageFile.getAbsolutePath());
        Uri uri = FileProvider.getUriForFile(AntarRekeningSukses.this, BuildConfig.APPLICATION_ID + ".provider", imageFile);
