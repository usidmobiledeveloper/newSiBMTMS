...
import com.usid.mobilebmt.mandirisejahtera.databinding.ActivityAntarBankSuksesBinding;
...
public class AntarBankSukses extends AppCompatActivity {

    ActivityAntarBankSuksesBinding binding;
    String judul;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityAntarBankSuksesBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        Utility.playNotificationSound(AntarBankSukses.this);
    ...
    private void takeScreenshot() {
        try {
            ...
            Toast.makeText(AntarBankSukses.this, "Gagal menyimpan screenshoot", Toast.LENGTH_SHORT).show();
            e.printStackTrace();
        }
    }
...
//        Uri uri = Uri.parse("file://" + imageFile.getAbsolutePath());
        Uri uri = FileProvider.getUriForFile(AntarBankSukses.this, BuildConfig.APPLICATION_ID + ".provider", imageFile);
