...
//
//public class DaftarDonaturNPWZ extends AppCompatActivity {
//    private SysDB dbsys;
...
//        dbsys = new SysDB(DaftarDonaturNPWZ.this);
//        dbsys.open();
//        dbsys.CreateTableDonatur();
//        int jumla = 0;
//        Cursor cur1 = dbsys.cekDonaturData();
//        if (cur1.moveToFirst()) {
//            jumla = cur1.getInt(0);
//        }
//        cur1.close();
...
//        rekening.clear();
//        nama.clear();
//        Cursor cur = dbsys.daftarDonatur();
//        if (cur.moveToFirst()) {
//            do {
//                HashMap<String, String> temp = new HashMap<String, String>();
//                temp.put("oprt", "Nama : " + cur.getString(1));
//                temp.put("nohp", "NPWZ : " + cur.getString(0));
//                list.add(temp);
...
//                SysDB dbsys = new SysDB(DaftarDonaturNPWZ.this);
//                dbsys.open();
//                dbsys.DeleteDonatur(rek);
//                dbsys.close();
//                finish();
//                dialog.dismiss();
//            }
