...
// */
//
//public class AuthLogin extends AsyncTask<Void, Void, Boolean> {
//    Context mContext;
//    boolean stat;
...
//
//    public AuthLogin(IAsyncHandler h, Context context) {
//        mContext = context;
//        handler = h;
//    }
//
...
//
//            psrsm = new ApExeSky2(mContext).encrypt(salt1 + ":" + salt2 + strTgl);
//            URL obj = new URL(new NumSky(mContext).decrypt(mContext.getResources().getString(R.string.urlLogin)));
